...
namespace IYFD.Controllers
{
    public class AdminController : UserController
    {
        ...
        {
            CheckUser(Models.Content.AdminHome); 
            return View();
        }
        ...
        public ActionResult MatchUps(string id)
        {
            try
            {
                CheckUser(Models.Content.Matchups);
        ...
        {
            CheckUser(Models.Content.TournyEntry); 
        ...
        public ActionResult Regions()
        {
            try
            {
                CheckUser(Models.Content.Regions);
                List<Region> regions = _data.GetAllRegions();
                ViewBag.Regions = regions;
            }
            catch (Exception ex)
        ...
        {
            CheckUser(Models.Content.GenTourny);
            return View();
        }
        ...
        public ActionResult GenerateMatchups()
        {
            try
            {
                CheckUser(Models.Content.GenMatchup);
        ...
        public ActionResult PickWinner(string id)
        {
            ...
            try
            {
                CheckUser(Models.Content.PickWinner);
        ...
        public ActionResult UserPanel()
        {
            try
            {
                CheckUser(Models.Content.UserPanel);
        ...
        public ActionResult MimicPlay(string id, string round)
        {
            ...
            try
            {
                CheckUser(Models.Content.MimicPlay);
        ...
        {
            CheckUser(Models.Content.ActivateUser);
            int userId;
        ...
        {
            CheckUser(Models.Content.ChangeUserPass);
            return View();
        }
